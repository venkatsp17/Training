...
{
    public class ShoppingBLCheckQuantityGreaterthan5Test
    {
        ...
        [Test]
        public void CheckQuantityGreaterthan5SuccessTest()
        {
            //Arrange
            ...
            //Action
            var result = _cartServices.CheckQuantityGreaterthan5(1);
            //Assert
            Assert.That(result, Is.False);
        }

        [Test]
        public void CheckQuantityGreaterthan5EmptyCartExceptionTest()
        {
            //Arrange
            ...
            _cartServices = new CartBL(_cartRepository);
            //Action
            var exception = Assert.Throws<EmptyCartException>(() => _cartServices.CheckQuantityGreaterthan5(1));
            //Assert
            Assert.That(exception.Message, Is.EqualTo("Cart is Empty"));
        }

        [Test]
        public void CheckQuantityGreaterthan5NoCartFoundExceptionTest()
        {
            //Arrange
            _cartServices = new CartBL(_cartRepository);
            //Action
            var exception = Assert.Throws<NoCartWithGiveIdException>(() => _cartServices.CheckQuantityGreaterthan5(1));
            //Assert

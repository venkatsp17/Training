...
namespace ShoppingBLTest.CustomerBLTest
{
    public class CustomerBLCreateNewCustomerTest
    {
        ...
        [Test]
        public void CreateNewCustomerSuccessTest()
        {
            //Arrange
            Customer customer = new Customer() { Age = 32, Name = "John", Phone = "9535353252" };
            //Action
            var result = _customerServices.CreateNewCustomer(customer);
            //Assert
        ...
        public void CreateNewCustomerDuplicatDataExceptionTest()
        {
            ...
            //Action
            var exception = Assert.Throws<DuplicateDataFoundException>(() => _customerServices.CreateNewCustomer(customer));
            //Assert

...
namespace ShoppingBLTest.CartBLTest
{
    public class CartBLRemoveCartItemTest
    {
        ...
        public void RemoveFromCartSuccessTest()
        {
            //Arrange
            //Action
            var result = _cartServices.RemoveItemFromCart(1, 1);
            //Assert
        ...
        public void RemoveFromCartItemNotExceptionTest()
        {
            ...
            //Action
            var exception = Assert.Throws<CartItemNotFoundException>(() => _cartServices.RemoveItemFromCart(1, 1));
            //Assert
        ...
        public void RemoveFromCartNoCartFoundExceptionTest()
        {
            ...
            var exception = Assert.Throws<NoCartWithGiveIdException>(() => _cartServices.RemoveItemFromCart(1, 2));
            //Assert

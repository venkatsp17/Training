...
namespace ShoppingBL
{
    public class CustomerBL : ICustomerServices
    {
        ...
        public async Task<Customer> UpdateCustomerName(string customerName, int CustomerId)
        {
            var result = _customerRepository.GetByKey(CustomerId);
            if (result != null)
            {
        ...
        public async Task<Customer> UpdateCustomerPhNumber(string phoneNumber, int CustomerId)
        {
            var result = _customerRepository.GetByKey(CustomerId);
            if (result != null)
            {

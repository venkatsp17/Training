...
namespace ShoppingBLTest.CartBLTest
{
    public class CartBLCheckForDiscountTest
    {
        ...
        [Test]
        public async Task CheckForDiscountSuccessTest()
        {
            //Arrange
            ...
            //Action
            var result = await _cartServices.CheckForDiscount(cart);
            //Assert
        ...
        public void CheckForDiscountEmptyCartExceptionTest()
        {
            ...
            _cartServices = new CartBL(_cartRepository);
            //Action
            var exception = Assert.ThrowsAsync<EmptyCartException>(() => _cartServices.CheckForDiscount(cart));
            //Assert

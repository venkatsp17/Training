...
namespace ShoppingBLTest.CartBLTest
{
    public class Tests
    {
        ...
        [Test]
        public async Task CheckForChargesSuccessTest()
        {
            //Arrange
            ...
            //Action
            var result = await _cartServices.CheckForCharges(cartItems);
            //Assert
        ...
        public void CheckForChargesEmptyCartExceptionTest()
        {
            ...
            _cartServices = new CartBL(_cartRepository);
            //Action
            var exception = Assert.ThrowsAsync<EmptyCartException>(() => _cartServices.CheckForCharges(cartItems));
            //Assert

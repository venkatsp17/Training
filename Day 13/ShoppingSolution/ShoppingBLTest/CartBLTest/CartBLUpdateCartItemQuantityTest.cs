...
namespace ShoppingBLTest.CartBLTest
{
    public class CartBLUpdateCartItemQuantityTest
    {
        ...
        [Test]
        public async Task UpdateCartQuantitySuccessTest()
        {
            //Arrange

            //Action
            var result = await _cartServices.UpdateCartItemQuantity(1, 1, 2);
            //Assert
        ...
        public void UpdateCartQuantityExceededExceptionTest()
        {
            ...
            //Action
            var exception = Assert.ThrowsAsync<CartItemQuantityExceededException>(() => _cartServices.UpdateCartItemQuantity(1, 1, 6));
            //Assert
        ...
        public void UpdateCartQuantityNoCartFoundExceptionTest()
        {
            ...
            //Action
            var exception = Assert.ThrowsAsync<NoCartWithGiveIdException>(() => _cartServices.UpdateCartItemQuantity(1, 2, 4));
            //Assert
        ...
        public void UpdateCartQuantityCartItemNotFoundExceptionTest()
        {
            ...
            //Action
            var exception = Assert.ThrowsAsync<CartItemNotFoundException>(() => _cartServices.UpdateCartItemQuantity(4, 1, 4));
            //Assert
